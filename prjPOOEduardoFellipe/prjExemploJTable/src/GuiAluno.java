...
public class GuiAluno extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblAluno.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "RA", "Nome", "1ª Nota", "2ª Nota", "Média", "Situação"
            }
        ) {
    ...
    private void btnAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdicionarActionPerformed
        ...
        double media = (Double.parseDouble(txtNtPrv1.getText()) + Double.parseDouble(txtNtPrv2.getText())) / 2;
        modTblAluno.setValueAt(df.format(media), modTblAluno.getRowCount() -1, 4);
        if(media < 5) {
                    modTblAluno.setValueAt("Reprovado", modTblAluno.getRowCount() -1, 5);
        } else {
            modTblAluno.setValueAt("Aprovado", modTblAluno.getRowCount() -1, 5);
        }
