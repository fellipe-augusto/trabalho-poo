...
public class DaoPedido {
    ...
    public void inserir(Pedido pedido) {
        ...
        try {
            ps = conn.prepareStatement("INSERT INTO pooPedido(numero, dataEmissao, dataPagto, formaPagto, situacao) VALUES(?,?,?,?,?)");
    ...
    public void alterar(Pedido pedido) {
        PreparedStatement ps = null;
        try {
            ps = conn.prepareStatement("UPDATE pooPedido set dataEmissao = ?, dataPagto = ?, formaPagto = ?, situacao = ?" +
                                                 "where numero = ?");
